...
class Clickpointtoedit:
    ...
    def show_help_dock(self):
        ...
        help_text = QLabel(
            ...
            "1. Please Select Vector Layer. : เลือกชั้นข้อมูลที่ต้องการแก้ไข \n"
            "2. Click Geometry type to edit. คลิกเลือก Geometry ที่ต้องการแก้ไขข้อมูล \n"
            "3. Edit data in field. กรอกข้อมูลในแถบแก้ไขที่ปรากฏทางขวา\n"
            "5. Done Export Log Report to CSV file just put push Export button. สามารถออกรายงานเป็น CSV แค่กดปุ่ม Export \n\n"
            "Click Geometry type to hide. คลิกที่ Geometry type เพื่อซ่อนข้อความนี้"
        )
